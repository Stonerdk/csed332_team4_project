...
public class HalsteadTest {
    ...
    public void testIfElse() throws IOException {
        ...
        filename = "C:\\SwMetrics\\SwMetrics\\src\\test\\java\\testfile\\IfElseExample.java";
        ...
        //Assert.assertEquals(38, metricInfo.getTotalOperands());
        Assert.assertEquals(17, metricInfo.getTotalOperators());
        //Assert.assertEquals(17, metricInfo.getDistOperands());
    ...
    @Test
    public void testForWhileElse() throws IOException {
        String filename = null;
        filename = "C:\\SwMetrics\\SwMetrics\\src\\test\\java\\testfile\\ForWhileExample.java";
        char[] fileread = ReadFileToCharArray(filename);
        ASTVisitorSearch ASTVisitorFile;
        ASTVisitorFile = parse(fileread, 2);
